"""
Django settings for car_deal project.
...
SECRET_KEY = '^c2_2!kqrxt2!9iogkecl&pw*(7^e29t0sm38xs0(j3v4p%#cb'
...
WSGI_APPLICATION = 'car_deal.wsgi.application'
